...
const CATEGORIES = ['All', 'Weight Belts', 'Cutting Equipment', 'Diving Gear', 'Industrial'];
    ...
    <div style={{ fontFamily: "'DM Sans', sans-serif", minHeight: '80vh' }}>
      ...
      <div style={{ background: '#0a2342', color: '#fff', padding: '48px 0' }}>
        <div className="container">
          <h1 style={{ fontFamily: "'Playfair Display', serif", fontWeight: 700, margin: 0 }}>Our Products</h1>
      ...
      <div className="container py-5">
        ...
        {loading ? (
          ...
          <div className="text-center py-5">
            <i className="bi bi-search" style={{ fontSize: 48, color: '#dee2e6' }}></i>
